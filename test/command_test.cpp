...
TEST_CASE("command values", "[bkrl][command]") {
    ...
    switch (cmd) {
        ...
        case ct::raw              : static_assert(static_cast<uint32_t>(ct::raw)  == 1, ""); break;
        case ct::text             : static_assert(static_cast<uint32_t>(ct::text) == 2, ""); break;
        case ct::invalid          : BK_CHECK_VAL(invalid); break;
        case ct::scroll           : BK_CHECK_VAL(scroll); break;
        case ct::zoom             : BK_CHECK_VAL(zoom); break;
        case ct::center_on_player : BK_CHECK_VAL(center_on_player); break;
